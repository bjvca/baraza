...
df_ols_NAcouldbe0 <- array("",dim=c(2,9,length(outcomes_NAcouldbe0)))
...
df_ols_NAcouldbe0[1,1,i] <- round(mean(as.matrix(sc_merged[outcomes_NAcouldbe0[i]]), na.rm=T),3)
df_ols_NAcouldbe0[2,1,i] <- paste(paste("(",round(sd(as.matrix(sc_merged[outcomes_NAcouldbe0[i]]), na.rm=T),3),sep=""),")",sep="")
...
for (i in 1:length(outcomes_nobaseline)) {
  print(i)
df_ols_nobaseline[1,1,i] <- round(mean(as.matrix(sc_merged[outcomes_nobaseline[i]]), na.rm=T),3)
df_ols_nobaseline[2,1,i] <- paste(paste("(",round(sd(as.matrix(sc_merged[outcomes_nobaseline[i]]), na.rm=T),3),sep=""),")",sep="")
