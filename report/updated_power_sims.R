...
#baseline <- read.csv("/home/bjvca/Dropbox (IFPRI)/baraza/Impact Evaluation Surveys/endline/data/public/baseline.csv", stringsAsFactors = TRUE)
#treats <- read.csv("/home/bjvca/Dropbox (IFPRI)/baraza/Impact Evaluation Surveys/endline/questionnaire/final_list_5.csv", stringsAsFactors = TRUE)
#wget https://www.dropbox.com/s/sakp13112o1to6u/baseline.csv?dl=0
baseline <- read.csv("baseline.csv", stringsAsFactors = TRUE)
#wget https://www.dropbox.com/s/bsvv2ggud2g7yrj/final_list_5.csv?dl=0
treats <- read.csv("final_list_5.csv", stringsAsFactors = TRUE)
...
df <- read.csv("/home/bjvca/Dropbox (IFPRI)/baraza/Impact Evaluation Surveys/endline/report/figure/wait_time_health.csv", stringsAsFactors = TRUE)
