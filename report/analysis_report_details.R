#### run this file for a detailed (exploratory) analysis
#### main output are the tables
...
save(df_ancova, file= paste(save_path,"df_ancova_details.Rd", sep="/"))
save(df_averages, file= paste(save_path,"df_averages_details.Rd", sep="/"))
save(baseline_desc, file= paste(save_path,"baseline_desc_details.Rd", sep="/"))

#table_maker <- function(res_mat,averages_mat, sel_list = c(7), file_path = "~/test.csv") {
## a table maker function for the 3ie report
